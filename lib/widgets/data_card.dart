        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
                borderRadius:
                    BorderRadius.all(Radius.circular(Screen.w(context) * 0.03)),
            ...
            children: [
              Text(
                ...
                style: TextStyle(
                    ...
                    color: Colors.black), // 16sp, w700
              ),
              SizedBox(height: Screen.h(context) * 0.008),
              Text(
                'Dealer: Green Energy Solutions',
                style: TextStyle(
                    fontSize: 12, fontWeight: FontWeight.w500), // 14sp, w400
              ),
            ],
          ),
            ...
            child: Center(
              child: Text(
                ...
                style: TextStyle(
                    fontSize: 14,
                    color: Colors.white,
                    fontWeight: FontWeight.bold), // 12sp, w500
              ),
            ),
          ),
        ],
