...
class LoginTabletView extends ConsumerStatefulWidget {
  const LoginTabletView({super.key});

  @override
  ConsumerState<LoginTabletView> createState() => _LoginScreenState();
}

class _LoginScreenState extends ConsumerState<LoginTabletView> {
        ...
        if (result.success) {
          switch (result.role) {
            ...
            default:
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(builder: (_) => const LoginTabletView()),
              );
          }
        }
      } finally {
