...
const _navItems = [
  ...
  _NavItem(icon: AppIcons.time,   label: 'Today'),
];
...
class _PackingMobileViewState extends ConsumerState<PackingMobileView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          // IndexedStack keeps pages alive between tab switches
...
class _FloatingNavBar extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Available width = screen - left(24) - right(24) margins
    final availableWidth = MediaQuery.sizeOf(context).width - 48;

    // Responsive thresholds — prevents the 28px overflow on small screens
